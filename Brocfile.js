...
*/
  ...
  var legacyFilesToAppend = [
    'gravetoids/config/environment.js',
    'gravetoids/config/environments/' + env + '.js',
    'jquery.js',
    'handlebars.js',
    'ember.js',
    'ic-ajax/main.js',
  ...
  appAndDependencies = preprocessJs(appAndDependencies, '/', 'gravetoids');
  ...
  //styles = preprocessCss(appAndDependencies, 'app/styles', '/assets');
